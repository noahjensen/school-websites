...
<body class="homepage desktop">
    ...
    watch: 'window'
			  ...
			  $('#header .state').click(function () {
				  $('.transparency').addClass('open');
			  });
			  $('.transparency .close').click(function () {
				  $('.transparency').removeClass('open');
			  });
			  //transparency END
            ...
            /* ---	Begin code to see section boxes titles when opening ---- */         
            $('.main .col-item h4').addClass('active');
      ...
      /* ---	End code to see section boxes titles when opening ---- */
