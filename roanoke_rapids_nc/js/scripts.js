$(document).ready(function () {
    ...
    $("#right-nav .menu-btn > span").click(function (e) {
    	...
    	if ($(window).width() > 980) {
    		 $(document).on("mouseenter", ".ul.second-nav li.has-child", function() {
    			//$(this).children('ul').stop().slideDown("slow");
                $(this).addClass("open");
    		});
    		$(document).on("mouseleave", ".ul.second-nav li.has-child", function() {
    			//$(this).children('ul').stop().slideUp("slow");
                 $(this).removeClass("open");
     		});
     	}
     	$('ul.second-nav').on('tap touchstart click', 'li.has-child span', function (e) {
     		e.preventDefault();
      ...
      $('ul.second-nav').on('tap touchstart click', 'li.has-child > a .arrow', function (e) {
     		e.preventDefault();
