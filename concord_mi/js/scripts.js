$(document).ready(function() {
  ...
  $('html').click(function() {
    ...
    $("#districts-nav .menu-btn > span").removeClass('active');
  ...
  //$('#districts-nav .menu-wrap').css("min-height", sliderheight);
  ...
  $(".menu-close").click(function(e) {
    //$("#left-nav .menu-wrap, #districts-nav .menu-wrap").css('min-height', 0).slideUp("slow");
    $("#left-nav, #districts-nav").removeClass('active');
  });
  $("#right-nav .menu-btn > span").click(function(e) {
    ...
    $("#left-nav").removeClass('active');
    $("#districts-nav .menu-btn > span").removeClass('active');
    $("#districts-nav .menu-wrap").slideUp();
