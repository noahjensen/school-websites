$(document).ready(function () {
   ...
   $('ul.second-nav > li.has-child > span, ul.second-nav > li.has-child > a').click(function () {
      if ($(this).parent().hasClass('open')) {
         $('ul.second-nav li.has-child > span, ul.second-nav li.has-child > a').next().stop().slideUp();
         $('ul.second-nav li.has-child > span, ul.second-nav li.has-child > a').parent().removeClass('open');
      } else {
         $('ul.second-nav li.has-child > span, ul.second-nav li.has-child > a').next().stop().slideUp();
         $('ul.second-nav li.has-child > span, ul.second-nav li.has-child > a').parent().removeClass('open');
   ...
   $('ul.second-nav li ul li.has-child > span, ul.second-nav li ul li.has-child > a').click(function () {
